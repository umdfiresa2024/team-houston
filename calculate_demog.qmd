...
transportation_vars <- c('B08101_025','B08101_009','B08101_017')
...
transname<-transportation %>%
  rename(Public_Transportation = B08101_025E, Drove_Alone = B08101_009E, Drove_carpooled = B08101_017E)
```
...
```{r}
tract_trans <- merge(shapevect, transname, by.x = "GEOID10", byy = "GEOID")

tract_trans$blockarea <- exapnse(block_trans, unit = 'm')
