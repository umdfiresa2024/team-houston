...
stat_data <- merged_tab%>%
  select(Station.x, city_num, date_parse, pm25, Tair_f_tavg, Wind_f_tavg, Qair_f_tavg, Swnet_tavg, Lwnet_tavg, Qle_tavg, Qh_tavg, Qg_tavg, Rainf_tavg, Qsb_tavg, AvgSurfT_tavg, SoilMoist_S_tavg, SoilMoist_RZ_tavg, SoilMoist_P_tavg, TVeg_tavg, ESoil_tavg, ACond_tavg, Rainf_f_tavg, Psurf_f_tavg, SWdown_f_tavg, month, DOW, holiday)
```
