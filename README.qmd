...
We identify pollution reductions per station by organizing stations into the PUMAs they reside in and identify the PM2.5 reduction by PUMAs. PUMAs are Public Use Microdata Areas provided by the U.S. census. We identify the pollution reduction by PUMA by creating a new linear regression model including the MetroOpen:as.factor(PUMACE10) as a variable.
